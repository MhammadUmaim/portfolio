    ...
    return (
        <div className="home__data">
            <h1 className="home__title">
                Muhammad Umaim
                <svg className='hand__icon' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="30" height="30" color="#000000" fill="none" stroke="#141B34" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
