        ...
        <div className="home__scroll">
            <a href="#about" className="home__scroll-button button--flex  ">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#000000" fill="none" stroke="#141B34" stroke-width="1.5">
                    ...
                    <path d="M11.9883 6.83984L11.9883 11.7598" />
                    <path d="M10.0039 7.86001C10.9859 6.84001 11.5847 5.94001 12.0398 6.00469C12.4231 6.0015 12.7823 6.60001 14.0039 7.86001" />
                    <path d="M13.9961 11.142C13.0141 12.162 12.4153 13.062 11.9602 12.9973C11.5769 13.0005 11.2177 12.402 9.99609 11.142" />
                </svg>
